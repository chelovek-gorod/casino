...
export const SLOTS_LINES_DATA = {
    ...
    [SLOTS.seven]: {count: 2, rates: MAX_WIN_RATE, extra: JACKPOT.rate7x7},
    [SLOTS.jackpot]: {count: 1, rates: MAX_WIN_RATE, extra: JACKPOT.rate7x7},

    [SLOTS.gold]: {count: 5, rates: LOW_WIN_RATE},
    [SLOTS.coin]: {count: 15, rates: LOW_WIN_RATE},

    [SLOTS.clover]: {count: 1, rates: LOW_WIN_RATE},
    [SLOTS.present]: {count: 1, rates: LOW_WIN_RATE},

    [SLOTS.wild]: {count: 5, rates: LOW_WIN_RATE},
    [SLOTS.bonus]: {count: 3, rates: LOW_WIN_RATE}, // выигрыш X
}
/* */
let imagesInLine = 0
